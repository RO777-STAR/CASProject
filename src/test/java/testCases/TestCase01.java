...
public class TestCase01 extends BaseClass {
	...
	void test1() {
		...
		Assert.assertEquals(driver.findElement(By.id("mectrl_currentAccount_primary")).getText(),"Singha, Rohan (Contractor)");
		Assert.assertEquals(driver.findElement(By.id("mectrl_currentAccount_secondary")).getText(),"2318120@cognizant.com");
