...
public class TestCase02 extends BaseClass{
 ...
 //storing all the data into Excel
		...
		File file = new File("C:\\Users\\2318120\\OneDrive - Cognizant\\Desktop\\CASPROJECT.xlsx");
	...
	for(int i=0;i<list.size()/2;i++) {
		...
		FileOutputStream outputStream = new FileOutputStream("C:\\Users\\2318120\\OneDrive - Cognizant\\Desktop\\CASPROJECT.xlsx");
